...
**************************************************************************************************
	...
	Este script é uma versão modificada do CTLD original. Foi traduzido traduzido para o português e feito várias modificações que consideramos ter melhorado ainda mais, trazendo uma ótima experiência de jogo.
	
	EDITADO POR GUTO, FABIANO VIKING, [BRA]SON dos esquadrões WOLFPACK e BRA. Contribuição de FERREIRA e SKY por terem adicionado os objetos da parte da FOB responsável por rearmar e reabastecer.
	ÚLTIMA MODIFICAÇÃO EM: 08 de Março de 2022
...
ctld.minimumDeployDistance = 1000 -- minimum distance from a friendly pickup zone where you can deploy a crate / DISTÂNCIA MÍNIMA PARA ABRIR UMA CARGA/CONTAINER/CRATE
...
ctld.crateWaitTime = 60 -- Tempo em segundos para aguardar antes de poder spawnar um novo container (crate) / tempo original era 120 segundos
...
ctld.deployedBeaconBattery = 30 -- duração em minutos da bateria dos beacons de rádios até precisarem ser re-spawnados / the battery on deployed beacons will last for this number minutes before needing to be re-deployed
...
ctld.pickupZones = {
	...
	{ "CVN-74", "none", -1, "yes", 0, 1002 },
	{ "LHD", "none", -1, "yes", 0, 1003 },
	{ "B_PortaAvioes-1", "none", -1, "yes", 2, 1021 },
	{ "B_PortaAvioes-2", "none", -1, "yes", 2, 1022 },
	{ "B_PortaAvioes-3", "none", -1, "yes", 2, 1023 },
	{ "R_PortaAvioes-1", "none", -1, "yes", 1, 1011 },
	{ "R_PortaAvioes-2", "none", -1, "yes", 1, 1012 },
	{ "R_PortaAvioes-3", "none", -1, "yes", 1, 1013 },
}
...
--*******LIMITAR O NÚMERO DE SOLDADOS E PASSAGEIROS QUE PODEM SER TRANSPORTADOS PELAS AERONAVES ABAIXO***************************
...
ctld.unitLoadLimits = {
	...
	["MI-24P"] = 8,
	["CH47 Chinook"] = 33,
	["Sikorsky CH-53E Super Stallion"] = 37,
	["UH-60L"] = 14,
...
ctld.loadableGroups = {
    {name = "Infantaria Padrão", inf = 6, mg = 2, at = 2 }, -- will make a loadable group with 6 infantry, 2 MGs and 2 anti-tank for both coalitions
    {name = "Infantaria Antiaéreo", inf = 2, aa = 3  },
    {name = "Infantaria Anti Tanques", inf = 2, at = 6  },
    {name = "Morteiros", mortar = 4, inf = 1, mg = 1 },
    {name = "Infantaria e JTAC", inf = 4, jtac = 1 }, -- will make a loadable group with 4 infantry and a JTAC soldier for both coalitions
    {name = "Único JTAC", jtac = 1 }, -- will make a loadable group witha single JTAC soldier for both coalitions
    {name = "Mortar Squad Red", inf = 2, mortar = 5, side =1 }, --would make a group loadable by RED only
	{name = "Esquadão", inf = 6, mg = 2, at = 2, aa = 1 },
}
...
ctld.spawnableCrates = {
    ...
    ["Veiculos e Blindados Leves"] = {
		...
		-- Vermelho
        { weight = 335, desc = "UAZ-469 Jeep - JATC", unit = "UAZ-469", side = 1, },
        { weight = 521, desc = "GAZ Tigr - JATC", unit = "Tigr_233036", side = 1, },
        { weight = 526, desc = "SKP-11 - JTAC", unit = "SKP-11", side = 1, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 516, desc = "APC BRDM-2", unit = "BRDM-2", side = 1, },
        { weight = 663, desc = "APC BTR-D", unit = "BTR_D", side = 1, },	
		{ weight = 603, desc = "APC MTLB", unit = "MTLB", side = 1, },
		{ weight = 131, desc = "APC BTR-80", unit = "BTR-80", side = 1 , cratesRequired = 2 },
        { weight = 185, desc = "APC BTR-82A", unit = "BTR-82A", side = 1 , cratesRequired = 2 },
        { weight = 252, desc = "Ural-375 Ammo Truck", unit = "Ural-375", side = 1 , cratesRequired = 2 },

		-- Azul		
        { weight = 523, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 506, desc = "HMMWV - MG", unit = "M1043 HMMWV Armament", side = 2 },
        { weight = 504, desc = "HMMWV - TOW", unit = "M1045 HMMWV TOW", side = 2 },
        { weight = 512, desc = "Scout Cobra", unit = "Cobra", side = 2, },
        { weight = 628, desc = "TPZ Fuchs", unit = "TPZ", side = 2, },
		{ weight = 287, desc = "APC M-113", unit = "M-113", side = 2, cratesRequired = 2 },
		{ weight = 298, desc = "APC AAV-7 Amphibios", unit = "AAV7", side = 2, cratesRequired = 2 },
	    { weight = 253, desc = "M-818 Ammo Truck", unit = "M 818", side = 2, cratesRequired = 2 },

		-- Todos
        { weight = 790, desc = "Pequeno Container de FOB", unit = "FOB-SMALL" }, -- Builds a FOB! - requires 3 * ctld.cratesRequiredForFOB
    },
	["Blindados Pesados e artilharia"] = {
	
		-- Vermelho
	    --{ weight = 228, desc = "IFV BMD-1", unit = "BMD-1", side = 1 , cratesRequired = 2 },
        --{ weight = 304, desc = "IFV BMP-1", unit = "BMP-1", side = 1 , cratesRequired = 2 },
        { weight = 327, desc = "IFV BMP-2", unit = "BMP-2", side = 1 , cratesRequired = 2 },
        { weight = 281, desc = "IFV BMP-3", unit = "BMP-3", side = 1 , cratesRequired = 3 },
	    { weight = 333, desc = "LT PT-76", unit = "PT_76", side = 1 , cratesRequired = 2 },
        --{ weight = 513, desc = "MBT T-55", unit = "T-55", side = 1 , cratesRequired = 2 },
        --{ weight = 313, desc = "MBT T-72B", unit = "T-72B", side = 1 , cratesRequired = 3 },
        --{ weight = 351, desc = "MBT T-72B3", unit = "T-72B3", side = 1 , cratesRequired = 3 },
        --{ weight = 361, desc = "MBT T-80UD", unit = "T-80UD", side = 1 , cratesRequired = 3 },
        { weight = 385, desc = "MBT T-90", unit = "T-90", side = 1 , cratesRequired = 3 },
		{ weight = 203, desc = "Grad MRL FDDM", unit = "Grad_FDDM", side = 1, cratesRequired = 2 },
        { weight = 204, desc = "SPH 2S9 Nona 120mm", unit = "SAU 2-C9", side = 1, cratesRequired = 2 },
        --{ weight = 205, desc = "SPH 2S1 Gvozdika 122mm", unit = "SAU Gvozdika", side = 1, cratesRequired = 2 },
        --{ weight = 206, desc = "SPH 2S3 Akatsia 152mm", unit = "SAU Gvozdika", side = 1, cratesRequired = 2 },
		{ weight = 207, desc = "SPH 2S19 Msta 152mm", unit = "SAU Msta", side = 1, cratesRequired = 2 },
        { weight = 208, desc = "MRLS BM-21 GRAD 122mm", unit = "Grad-URAL", side = 1, cratesRequired = 2 },		
        --{ weight = 209, desc = "MRLS 9K57 Uragan BM-27 220mm", unit = "Uragan_BM-27", side = 1, cratesRequired = 3 },
        { weight = 354, desc = "MRLS 9A52 Smerch CM 300mm", unit = "Smerch", side = 1, cratesRequired = 3 },
        { weight = 356, desc = "MRLS 9A52 Smerch HE 300mm", unit = "Smerch_HE", side = 1, cratesRequired = 3 },
		
		-- Azul
		{ weight = 270, desc = "Stryker ICV", unit = "M1126 Stryker ICV", side = 2, cratesRequired = 2 },		
		{ weight = 285, desc = "Stryker ATGM", unit = "M1134 Stryker ATGM", side = 2, cratesRequired = 2 },
		{ weight = 402, desc = "Stryker MGS", unit = "M1128 Stryker MGS", side = 2, cratesRequired = 2 },
		{ weight = 331, desc = "IFV LAV-25", unit = "LAV-25", side = 2, cratesRequired = 2 },
		{ weight = 517, desc = "IFV M2 Bradley", unit = "M-2 Bradley", side = 2, cratesRequired = 3 },
		{ weight = 815, desc = "MBT M-1 Abrams", unit = "M-1 Abrams", side = 2, cratesRequired = 3 },
		{ weight = 256, desc = "ART M-109", unit = "M-109", side = 2, cratesRequired = 2 },
		{ weight = 511, desc = "ART MLRS M270", unit = "MLRS", side = 2, cratesRequired = 3 },
		
	},
    ["SAMs de curto alcance"] = {

		-- Vermelho
        --{ weight = 55, desc = "Igla", unit = "SA-18 Igla manpad", side = 1 },
        { weight = 192, desc = "AAA ZU-23 Emplacement", unit = "ZU-23 Emplacement", side = 1 },
        { weight = 601, desc = "SPAAA ZU-23-2 Montada Ural", unit = "Ural-375 ZU-23", side = 1 },
        { weight = 273, desc = "SPAAA ZSU-57-2", unit = "ZSU_57_2", side = 1, cratesRequired = 2 },
        { weight = 290, desc = "SPAAA ZSU-23-7 Shilka Gun Dish", unit = "ZSU-23-4 Shilka", side = 1, cratesRequired = 2 },
        { weight = 355, desc = "SAM SA-8 OSA Gecko", unit = "Osa 9A33 ln", side = 1, cratesRequired = 2 },		
        { weight = 401, desc = "SAM SA-9 Strela Gaskin", unit = "Strela-1 9P31", side = 1 },
        --{ weight = 195, desc = "SAM SA-13 Strela Gopher", unit = "Strela-10M3", side = 1, cratesRequired = 2 },
        { weight = 357, desc = "SAM SA-15 Tor Gauntlet", unit = "Tor 9A331", side = 1, cratesRequired = 2 },
        { weight = 325, desc = "SAM SA-19 Tunguska Grison", unit = "2S6 Tunguska", side = 1, cratesRequired = 2 },

		
		--Azul
		{ weight = 250, desc = "AAA Bofors 40mm", unit = "bofors40", side = 2 },
		{ weight = 201, desc = "SPAAA Vulcan M163", unit = "Vulcan", side = 2, cratesRequired = 2 },
		{ weight = 210, desc = "SPAAA Gepard", unit = "Gepard", side = 2, cratesRequired = 2 },
		{ weight = 543, desc = "M48 Chaparral", unit = "M48 Chaparral", side = 2 },
        { weight = 151, desc = "M1097 Avenger", unit = "M1097 Avenger", side = 2, cratesRequired = 2 },
        --{ weight = 234, desc = "Roland", unit = "Roland ADS", side = 2, cratesRequired = 2 },		
		--{ weight = 51, desc = "Stinger", unit = "Soldier stinger", side = 2 },
		
		{ weight = 558, desc = "MCC-SR Sborka Dog Ear", unit = "Dog Ear radar", }, --EWR para os dois lados

    },
    ["SAMs de médio alcance"] = {
        -- HAWK System
        { weight = 544, desc = "HAWK Launcher", unit = "Hawk ln", side = 2},
        ...
        { weight = 548, desc = "HAWK Repair", unit = "HAWK Repair" , side = 2 },
        -- End of HAWK
		
		-- NASAMS System
        --{ weight = 549, desc = "NASAMS Lançador - AIM120-B", unit = "NASAMS_LN_B", side = 2},
        --{ weight = 550, desc = "NASAMS Lançador - AIM120-C", unit = "NASAMS_LN_C", side = 2 },
        --{ weight = 551, desc = "NASAMS Track Radar", unit = "NASAMS_Radar_MPQ64F1", side = 2 },
        --{ weight = 552, desc = "NASAMS Posto de Commando", unit = "NASAMS_Command_Post" , side = 2 }, -- Remove this if on 1.2
        --{ weight = 553, desc = "NASAMS Repair", unit = "NASAMS Repair" , side = 2 },
        -- End of NASAMS
		
		-- Rapier System
        --{ weight = 554, desc = "Rapier Blindfire Lançador - AIM120-B", unit = "rapier_fsa_launcher", side = 2},
        --{ weight = 555, desc = "Rapier Blindfire Lançador - AIM120-C", unit = "NASAMS_LN_C", side = 2 },
        --{ weight = 556, desc = "Rapier Blindfire Track Radar", unit = "rapier_fsa_blindfire_radar", side = 2 },
        --{ weight = 557, desc = "Rapier Blindfire Tracker Optico", unit = "rapier_fsa_optical_tracker_unit" , side = 2 }, -- Remove this if on 1.2
        --{ weight = 558, desc = "Rapier Blindfire Repair", unit = "Rapier Repair" , side = 2 },
        -- End of Rapier
		
		-- Roland System
        { weight = 559, desc = "Roland Lançador", unit = "Roland ADS", side = 2, },
        { weight = 560, desc = "Roland Track Radar", unit = "Roland Radar", side = 2 },
        { weight = 561, desc = "Roland Repair", unit = "Roland Repair" , side = 2 },
        -- End of Roland

        -- KUB SYSTEM
        { weight = 562, desc = "KUB Launcher", unit = "Kub 2P25 ln", side = 1},
        { weight = 563, desc = "KUB Radar", unit = "Kub 1S91 str", side = 1 },
        { weight = 564, desc = "KUB Repair", unit = "KUB Repair", side = 1},
        -- End of KUB

        -- BUK System
        { weight = 565, desc = "BUK Launcher", unit = "SA-11 Buk LN 9A310M1", side = 1},
        { weight = 566, desc = "BUK Search Radar", unit = "SA-11 Buk SR 9S18M1", side = 1},
        { weight = 567, desc = "BUK CC Radar", unit = "SA-11 Buk CC 9S470M1", side = 1},
        { weight = 568, desc = "BUK Repair", unit = "BUK Repair", side = 1},
        -- END of BUK
		
        -- HQ-7 System Chines	
        --        { weight = 569, desc = "HQ-7 Self Propelled Launcher", unit = "HQ-7_LN_SP", side = 1},
		--        { weight = 570, desc = "HQ-7 Self Propelled Radar", unit = "HQ-7_STR_SP", side = 1},
		--        { weight = 571, desc = "HQ-7 Self Propelled Repair", unit = "HQ-7 Repair" , side = 2 },
		-- END of HQ-7
		
		{ weight = 586, desc = "Early Warning Radar 1L13", unit = "1L13 EWR", cratesRequired = 2 }, --EWR para os dois lados
    },
    ["SAMs de longo alcance"] = {
        -- Patriot System
        { weight = 572, desc = "Patriot Launcher", unit = "Patriot ln", side = 2 },
        { weight = 573, desc = "Patriot Radar", unit = "Patriot str" , side = 2 },
        { weight = 574, desc = "Patriot ECS", unit = "Patriot ECS", side = 2 },
        { weight = 575, desc = "Patriot ICC", unit = "Patriot cp", side = 2 },
        { weight = 576, desc = "Patriot EPP", unit = "Patriot EPP", side = 2 },
        { weight = 577, desc = "Patriot AMG", unit = "Patriot AMG" , side = 2 },
        { weight = 578, desc = "Patriot Repair", unit = "Patriot Repair" , side = 2 },
        -- End of Patriot
		
        -- S-300 System
        { weight = 579, desc = "SA-10 S-300 Grumble Tel C Launcher", unit = "S-300PS 5P85D ln", side = 1 },
        { weight = 580, desc = "SA-10 S-300 Grumble Big Bird SR", unit = "S-300PS 64H6E sr" , side = 1 },
        { weight = 581, desc = "SA-10 S-300 Posto de Comando", unit = "S-300PS 54K6 cp", side = 1 },
        { weight = 582, desc = "SA-10 S-300 Grumble Clam Shell SR", unit = "S-300PS 40B6MD sr", side = 1 },
        { weight = 583, desc = "SA-10 S-300 Grumble Flap Lid TR", unit = "S-300PS 40B6M tr", side = 1 },
        { weight = 584, desc = "SA-10 S-300 Grumble Tel D Launcher", unit = "S-300PS 5P85C ln", side = 1 },
        { weight = 585, desc = "SA-10 S-300 Repair", unit = "SA-10 S-300 Repair" , side = 1 },
        -- End of S-300

        { weight = 586, desc = "Early Warning Radar 55G6", unit = "55G6 EWR", cratesRequired = 3 }, --EWR para os dois lados
    },
}

--- Modelo do objeto estático 3D usado para representar um crate/carga/container. O original era um Gerador e modificamos para um container
...
ctld.jtacUnitTypes = {
    "UAZ", "SKP", "Hummer", "Tigr" -- there are some wierd encoding issues so if you write SKP-11 it wont match as the - sign is encoded differently...
}
...
ctld.AASystemTemplate = {
    ...
    },
    {
        ...
        parts = {
			...
			{name = "Patriot cp", desc = "Patriot Command Station"},
			{name = "Patriot EPP", desc = "Patriot Electric Power Plant"},
			{name = "Patriot AMG", desc = "Patriot Antenna Mast Group"},
        },
    ...
    },
	{
        ...
        count = 4,
        parts = {
           	{name = "S-300PS 5P85D ln", desc = "SA-10 S-300 Grumble Tel C Launcher", launcher = true},
           	{name = "S-300PS 64H6E sr", desc = "SA-10 S-300 Grumble Big Bird SR"},
       		{name = "S-300PS 54K6 cp", desc = "SA-10 S-300 Posto de Comando"},
			{name = "S-300PS 40B6MD sr", desc = "SA-10 S-300 Grumble Clam Shell SR"},
			{name = "S-300PS 40B6M tr", desc = "SA-10 S-300 Grumble Flap Lid TR"},
			{name = "S-300PS 5P85C ln", desc = "SA-10 S-300 Grumble Tel D Launcher"},
       },
        repair = "SA-10 S-300 Repair",
    },
	{
        name = "BUK AA System",
        count = 4,
    ...
    },
	{
        ...
        count = 2,
        parts = {
            {name = "Roland ADS", desc = "Roland Lançador" , launcher = true},
            {name = "Roland Radar", desc = "Roland Track Radar"},
        },
    ...
    },
	{
        ...
        count = 2,
        parts = {
            {name = "HQ-7_LN_SP", desc = "HQ-7 Self Propelled Lançador" , launcher = true},
            {name = "HQ-7_STR_SP", desc = "HQ-7 Self Propelled Radar"},
        },
        repair = "HQ-7 Repair",
    },
}
...
function ctld.spawnFOB(_country, _unitId, _point, _name)
	...
	--ESSA PARTE SPAWNA O OUTPOST DA FOB
    local _crate = {
        ["category"] = "Fortifications",
        ["type"] = "outpost",
      --  ["unitId"] = _unitId,
	...
	--ESSA PARTE SPAWNA A TORRE DE MADEIRA DA FOB (house2arm)
...
--===========================================PARTE ADICIONADA PELO FERREIRA E SKY=========================================
	local _id2 = ctld.getNextUnitId()
    -- Adiciona Heliponto (farp invisível)
    local _crate = {
        ["category"] = "Heliports",
        ["type"] = "SINGLE_HELIPAD",
      --  ["unitId"] = _unitId,
    ...
    local _id3 = ctld.getNextUnitId()
    -- Adiciona Farp Fuel Depot (Cercado de cimentos com barris que fazem o abastecimento da farp)
    local _crate = {
        ["category"] = "Fortifications",
        ["type"] = "FARP Fuel Depot",
      --  ["unitId"] = _unitId,
        ["y"] = _point.z + -25.0000000,
        ["x"] = _point.x + 80.0000000,
        ["name"] = "FOB Fuel #".. _id3,
        ["canCargo"] = false,
        ["heading"] = 0,
    }
    ...
    local _id4 = ctld.getNextUnitId()
    -- ADICIONA AQUELA BARRAQUINHA DA FARP (um carinha na mesa em uma tenda com vários armamentos ao redor)
    local _crate = {
        ["category"] = "Fortifications",
        ["type"] = "FARP Ammo Dump Coating",
      --  ["unitId"] = _unitId,
        ["y"] = _point.z + -20.0000000,
        ["x"] = _point.x + 60.0000000,
        ["name"] = "FOB Ammo #".. _id4,
        ["canCargo"] = false,
        ["heading"] = 0,
    }
    ...
    local _status, _err = pcall(function(_args)
        ...
        if _crateType ~= nil and _heli ~= nil and ctld.inAir(_heli) == false then
            ...
            if ctld.inLogisticsZone(_heli) == false then
                ...
                ctld.displayMessageToGroup(_heli, "Você não está próximo do depósito o suficiente para carregar um container!", 10)
            ...
            if _heli:getPlayerName() ~= nil and ctld.crateWait[_heli:getPlayerName()] and  ctld.crateWait[_heli:getPlayerName()] > timer.getTime() then
                ...
                ctld.displayMessageToGroup(_heli,"Você deve aguardar "..(ctld.crateWait[_heli:getPlayerName()]  - timer.getTime()).. " segundos antes de requisitar um novo container", 20)
                return
            end
            ...
            ctld.displayMessageToGroup(_heli, string.format("Uma carga de %s pesando %s kg foi descarregada a sua frente ", _crateType.desc, _crateType.weight), 20)

        else
            env.info("Item de Carga para spawnar não encontrado")
        end
    end, _arguments)
    ...
    if _troops then
            ...
            if ctld.inAir(_heli) == false or ctld.safeToFastRope(_heli) then
                ...
                if _extractZone == false then
                    ...
                    if ctld.inAir(_heli) then
                        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " tropas desembarcou rapidamente com as cordas do " .. _heli:getTypeName() .. " em combate", 10)
                    else
                        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " desembarcou tropas do " .. _heli:getTypeName() .. " em combate", 10)
						trigger.action.outSound('CS - Go Go Go.ogg')
                    end
                    ...
                    if ctld.inAir(_heli) then
                        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " tropas desceram rapidamente de cordas " .. _heli:getTypeName() .. " em " .. _extractZone.name, 10)
                    else
                        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " tropas desembarcou do " .. _heli:getTypeName() .. " em " .. _extractZone.name, 10)
                    end
                end
            else
                ctld.displayMessageToGroup(_heli, "Alto demais ou baixo demais para desembarcou tropas no combate! Faça um hover abaixo de " .. ctld.metersToFeet(ctld.fastRopeMaximumHeight) .. " pés ou pouse.", 10)
            end
        end
        ...
        if ctld.inAir(_heli) == false then
            if _onboard.vehicles ~= nil and #_onboard.vehicles.units > 0 then
                ...
                trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " veículos descarregados do " .. _heli:getTypeName() .. " para o combate", 10)
            end
        end
    end
end
...
function ctld.generateTroopTypes(_side, _countOrTemplate, _country)
    ...
    local _groupId = ctld.getNextGroupId()
    local _groupName = "Grupo extraído"
    if _hasJTAC then
        _groupName = "Grupo de JTAC extraído"
    end
    ...
    ctld.logTrace(string.format("peso total=%s", ctld.p(_weight)))
...
function ctld.loadTroops(_heli, _troops, _numberOrTemplate)
    ...
    if _troops then
        ...
        ctld.logTrace(string.format("_onboard.troops=%s", ctld.p(_onboard.troops)))
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " carregou tropas no " .. _heli:getTypeName(), 10)
		trigger.action.outSound('FA - Lets Move Out.ogg')
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " carregou " .. _count .. " veículos no " .. _heli:getTypeName(), 10)
    end
...
function ctld.loadUnloadFOBCrate(_args)
    ...
    if _inZone == false and _crateOnboard == true then
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " transportou um container de FOB", 10)

        ctld.displayMessageToGroup(_heli, "Transpotou um container de FOB 60m as suas 6 horas", 10)

    elseif _inZone == true and _crateOnboard == true then

        ctld.displayMessageToGroup(_heli, "Container de FOB descarregado de volta na base", 10)

        ctld.inTransitFOBCrates[_heli:getName()] = nil

    elseif _inZone == true and _crateOnboard == false then
        ctld.displayMessageToGroup(_heli, "Container de FOB carregado", 10)
        ...
        if _nearestCrate ~= nil and _nearestCrate.dist < 150 then
            ...
            ctld.displayMessageToGroup(_heli, "Não há unidades ou estruturas de logísticas próximas para carregar um container de FOB!", 10)
        end
    end
end
...
function ctld.loadTroopsFromZone(_args)
    ...
    if ctld.troopsOnboard(_heli, _troops) then
        ...
        if _troops then
            ctld.displayMessageToGroup(_heli, "Você já tem tropas a bordo!", 10)
        else
            ctld.displayMessageToGroup(_heli, "Você já tem veículos a bordo.", 10)
        end
    ...
    elseif _zone.inZone == true then
        ...
        if _zone.limit - 1 >= 0 then
            ...
            ctld.displayMessageToGroup(_heli, "Esta área não tem mais reforços disponíveis!", 20)
        ...
        if _allowExtract then
            ctld.displayMessageToGroup(_heli, "Você não está em uma zona de extração e ninguém está próximo para ser extraído.", 10)
        else
            ctld.displayMessageToGroup(_heli, "Você não está em uma zona de carregamento.", 10)
        end
...
function ctld.unloadTroops(_args)
    ...
    if not ctld.troopsOnboard(_heli, _troops)  then
        ...
        ctld.displayMessageToGroup(_heli, "Ninguém para ser extraído", 10)
        ...
        if _zone.inZone == true then
            ...
            if _troops then
                ctld.displayMessageToGroup(_heli, "Desembarcou tropas de volta na base", 20)
                ...
                ctld.displayMessageToGroup(_heli, "Descarregou veículos de volta para a base", 20)
    ...
    if _troops then
        ...
        if _extractTroops ~= nil then
            ...
            if _limit < #_extractTroops.group:getUnits() then
                ...
                ctld.displayMessageToGroup(_heli, "O grupo de ".._size.." é grande demais para caber. \n\nLimite é ".._limit.." para ".._heli:getTypeName(), 20)
            ...
            trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " tropas extraídas para " .. _heli:getTypeName() .. " do combate", 10)
            ...
            _onboard.troops = nil
            ctld.displayMessageToGroup(_heli, "Nenhuma tropa para ser extraída por aqui!", 20)
        end
        ...
        if _extractVehicles ~= nil then
            ...
            trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " extraiu veículos no " .. _heli:getTypeName() .. " do combate", 10)
            ...
            ctld.displayMessageToGroup(_heli, "Nenhum veículo transportável por perto!", 20)
        end
    end
...
function ctld.getWeightOfCargo(unitName)
    ...
    if ctld.inTransitTroops[unitName] then
        ...
        if _inTransit then
            ...
            if _troops and _troops.units then
                ...
                _description = _description .. string.format("%s tropas a bordo (%s kg)\n", #_troops.units, _troops.weight)
            ...
            if _vehicles and _vehicles.units then
                ...
                ctld.logTrace(string.format("_weight=%s", ctld.p(_weight)))
                _description = _description .. string.format("%s veículos a bordo (%s kg)\n", #_vehicles.units, _weight)
            end
        end
    end
    ctld.logTrace(string.format("com tropas e veículos : peso = %s", tostring(_weight)))
    ...
    if ctld.inTransitFOBCrates[unitName] then
        ...
        _description = _description .. string.format("1 container de FOB a bordo (%s kg)\n", FOB_CRATE_WEIGHT)
    end
    ctld.logTrace(string.format("com container de FOB : peso = %s", tostring(_weight)))
    ...
    if _crate then
        ...
        if _crate.simulatedSlingload then
            ...
            _description = _description .. string.format("1 %s container a bordo (%s kg)\n", _crate.desc, _crate.weight)
        end
    end
    ctld.logTrace(string.format("with simulated slingload crates : weight = %s", tostring(_weight)))
    if _description ~= "" then
        _description = _description .. string.format("Peso total da carga : %s kg\n", _weight)
    else
        _description = "Sem carga!."
    end
                ...
                for _, _crate in pairs(_crates) do
                    ...
                    if _crate.dist < ctld.maxDistanceFromCrate and _crate.details.unit ~= "FOB" then
                        ...
                        if _height > ctld.minimumHoverHeight and _height <= ctld.maximumHoverHeight then
                            ...
                            if _time > 0 then
                                ctld.displayMessageToGroup(_transUnit, "Fazendo hover acima " .. _crate.details.desc .. " carga. \n\nFaça um hover por " .. _time .. " segundos! \n\nSe a contagem parar é porque você está longe!", 10,true)
                            else
                                ctld.hoverStatus[_transUnit:getName()] = nil
                                ctld.displayMessageToGroup(_transUnit, "Carregou uma carga de  " .. _crate.details.desc .. " !", 10,true)
                        ...
                        elseif _height <= ctld.minimumHoverHeight then
                            ctld.displayMessageToGroup(_transUnit, "Baixo demais para enganchar " .. _crate.details.desc .. " container.\n\nMantenha o hover por " .. ctld.hoverTime .. " segundos", 5,true)
                            break
                        else
                            ctld.displayMessageToGroup(_transUnit, "Alto demais para enganchar " .. _crate.details.desc .. " container.\n\nMantenha o hover por " .. ctld.hoverTime .. " segundos", 5, true)
                            break
                        end
                    end
                end
...
function ctld.loadNearbyCrate(_name)
    ...
    if _transUnit ~= nil  then
        ...
        if ctld.inAir(_transUnit) then
            ctld.displayMessageToGroup(_transUnit, "Você deve pousar antes de carregar um container!", 10,true)
            return
        end
        ...
        if ctld.inTransitSlingLoadCrates[_name] == nil then
            ...
            for _, _crate in pairs(_crates) do
                ...
                if _crate.dist < 50.0 then
                    ctld.displayMessageToGroup(_transUnit, "Carregou uma carga de  " .. _crate.details.desc .. " !", 10,true)
					trigger.action.outSound('Cargo Onboard.ogg') --ÁUDIO de carga a bordo somente voz
            ...
            ctld.displayMessageToGroup(_transUnit, "Nenhuma carga dentro de 50m para carregar!", 10,true)

        else
            -- crate onboard
            ctld.displayMessageToGroup(_transUnit, "Você já tem uma carga de "..ctld.inTransitSlingLoadCrates[_name].desc.." a bordo!", 10,true)
        end
    end
...
function ctld.listNearbyCrates(_args)
    ...
    for _, _crate in pairs(_crates) do
        ...
        if _crate.dist < 1000 and _crate.details.unit ~= "FOB" then
            _message = string.format("%s\n%s Container - kg %i - %i m - %d o'clock", _message, _crate.details.desc, _crate.details.weight, _crate.dist, ctld.getClockDirection(_heli, _crate.crateUnit))
        end
    end
...
function ctld.listFOBS(_args)
    ...
    if _msg == "FOB Positions:" then
        ctld.displayMessageToGroup(_heli, "Não há nenhum FOB ativo!", 20)
    else
    ...
    local _status, _err = pcall(function(_args)
        ...
        if _heli ~= nil and ctld.inAir(_heli) == false then
            ...
            if ctld.inLogisticsZone(_heli) == true  or  ctld.farEnoughFromLogisticZone(_heli) == false then
                ...
                ctld.displayMessageToGroup(_heli, "Você não pode construir isso nessa área!", 20)
            ...
            elseif _crate ~= nil and _crate.dist < 200 then
                ...
                if ctld.forceCrateToBeMoved and ctld.crateMove[_crate.crateUnit:getName()] then
                    ctld.displayMessageToGroup(_heli,"Você deve mover essa carga antes de construí-la!", 20)
                    return
                end
                ...
                elseif _crate.details.cratesRequired ~= nil and _crate.details.cratesRequired > 1 then
                  ...
                  --  if ctld.slingLoad == false then
                   ...
                   -- end
                    ...
                    trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " desembarcou com sucesso um " .. _crate.details.desc .. " no campo de batalha", 10)
                ...
                ctld.displayMessageToGroup(_heli, "Não há cargas perto o suficiente para construir", 20)
            end
        end
    end, _arguments)
    ...
    for _, _nearbyCrate in pairs(_crates) do
        ...
        if _nearbyCrate.dist < 750  then
            ...
            if _smallFobCrates > 0 then
                _totalCrates = _bigFobCrates + (_smallFobCrates/3.0) --QUANTIDADE DE PEQUENOS CRATES (CONTAINERS) NECESSÁRIOS PARA CRIAR UMA FOB??? (número original é 3.0) Ou seja, precisa de 3 crates
            else
    ...
    if _totalCrates >= ctld.cratesRequiredForFOB then
        ...
        timer.scheduleFunction(function(_args)
            ...
            if ctld.troopPickupAtFOB == true then
                ...
                trigger.action.outTextForCoalition(_args[3], "Construção de FOB finalizado! Containers e tropas podem ser carregadas.", 10)
            else
                trigger.action.outTextForCoalition(_args[3], "Construção de FOB finalizado! Containers e tropas podem ser carregadas.", 10)
            end
        end, { _centroid, _heli:getCountry(), _heli:getCoalition() }, timer.getTime() + ctld.buildTimeFOB)

        local _txt = string.format("%s começou a construir um FOB utilizando %d containers de FOB, estará pronto em %d segundos.\nPosição marcada com fumaça.", ctld.getPlayerNameOrType(_heli), _totalCrates, ctld.buildTimeFOB)
        ...
        local _txt = string.format("Impossível construir FOB!\n\nÉ necessário %d containers de FOB grandes ( 3 pequenos containers de FOB é igual à 1 grande container de FOB ) e há o equivalente à %d grandes containers de FOB próximos\n\nOu os containers não estão à 750m de distância um do outro", ctld.cratesRequiredForFOB, _totalCrates)
        ctld.displayMessageToGroup(_heli, _txt, 20)
    end
end
...
function ctld.dropSlingCrate(_args)
    ...
    if _currentCrate == nil then
        if ctld.hoverPickup then
            ctld.displayMessageToGroup(_heli, "Você não está transportando nenhuma carga. \n\nPara pegar um container, faça um hover por "..ctld.hoverTime.." segundos acima do container", 10)
        else
            ctld.displayMessageToGroup(_heli, "Você não está transportando nenhuma carga. \n\nPara pegar um container - pouse e use os comandos de carga do F10 para carregar um.", 10)
        end
    else
        ...
        if ctld.inAir(_heli) == false or _heightDiff <= 7.5 then
            ctld.displayMessageToGroup(_heli, _currentCrate.desc .. " Container foi descarregado a sua frente", 10)
			trigger.action.outSound('Cargo Dropped.ogg') --ÁUDIO de carga descarregada somente voz
        ...
        elseif _heightDiff > 7.5 and _heightDiff <= 40.0 then
            ctld.displayMessageToGroup(_heli, _currentCrate.desc .. " container foi descarregado abaixo de você com segurança", 10)
        else -- _heightDiff > 40.0
            ctld.inTransitSlingLoadCrates[_heli:getName()] = nil
            ctld.displayMessageToGroup(_heli, "Você está alto demais! A carga foi destruída", 10)
            return
        end
...
function ctld.listRadioBeacons(_args)
    ...
    if _heli ~= nil then
        ...
        if _message ~= "" then
            ...
            ctld.displayMessageToGroup(_heli, "Não há beacons de rádio ativos!", 20)
        end
    end
end
...
function ctld.dropRadioBeacon(_args)
    ...
    if _heli ~= nil and ctld.inAir(_heli) == false then
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " colocou um Beacon de rádio no solo.\n\n" .. _radioBeaconDetails.text, 20)

    else
        ctld.displayMessageToGroup(_heli, "Você precisa pousar antes de colocar um Beacon de rádio!", 20)
    end
end
...
function ctld.removeRadioBeacon(_args)
    ...
    if _heli ~= nil and ctld.inAir(_heli) == false then
        ...
        if _closetBeacon ~= nil and _shortestDistance then
            ...
            trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " removeu um beacon de rádio.\n\n" .. _closetBeacon.text, 20)
        else
            ctld.displayMessageToGroup(_heli, "Não há Beacons de rádio em um raio de 500m.", 20)
        end

    else
        ctld.displayMessageToGroup(_heli, "Você precisa pousar antes de remover um beacon de rádio!", 20)
    end
end
    ...
    if ctld.getLauncherUnitFromAATemplate(_aaSystemTemplate) == _nearestCrate.details.unit then
        ...
        if _nearestSystem ~= nil and _nearestSystem.dist < 300 then
            ...
            if ctld.countTableEntries(_uniqueTypes) == _aaSystemTemplate.count and #_points >= _aaSystemTemplate.count then
                ...
                trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " rearmou com sucesso um sistema completo de ".._aaSystemTemplate.name.." no campo de batalha", 10)
...
function ctld.unpackAASystem(_heli, _nearestCrate, _nearbyCrates,_aaSystemTemplate)
    ...
    if _txt ~= ""  then
        ctld.displayMessageToGroup(_heli, "Impossível construir ".._aaSystemTemplate.name.."\n" .. _txt .. "\n\nOu as cargas não estão próximas o suficiente", 20)
        return
    else
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " construiu com sucesso um ".._aaSystemTemplate.name.." no campo de batalha. \n\nAA Active System limit is: ".._allowed.."\nActive: "..(_activeLaunchers+1), 10)
...
function ctld.repairAASystem(_heli, _nearestCrate,_aaSystem)
    ...
    if _nearestHawk ~= nil and _nearestHawk.dist < 300 then
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " reparou com sucesso um sistema completo de ".._aaSystem.name.." no campo de batalha", 10)
       ...
       -- end
        ...
        ctld.displayMessageToGroup(_heli, "Impossível reparar  ".._aaSystem.name..". Não existe ".._aaSystem.name.." danificado em um raio de 300m", 10)
    end
end
...
function ctld.unpackMultiCrate(_heli, _nearestCrate, _nearbyCrates)
    ...
    if #_nearbyMultiCrates == _nearestCrate.details.cratesRequired then
        ...
        local _txt = string.format("%s instalou com sucesso %s no campo de batalha utilizando %d containers", ctld.getPlayerNameOrType(_heli), _nearestCrate.details.desc, #_nearbyMultiCrates)

        trigger.action.outTextForCoalition(_heli:getCoalition(), _txt, 10)

    else

        local _txt = string.format("Impossível construir %s!\n\nÉ necessário %d containers e há somente %d \n\nOu os containers não estão a 300m próximos um do outro", _nearestCrate.details.desc, _nearestCrate.details.cratesRequired, #_nearbyMultiCrates)
...
function ctld.spawnCrateGroup(_heli, _positions, _types)
    ...
    if #_positions == 1 then
        ...
        local _unitId = ctld.getNextUnitId()
        local _details = { type = _types[1], unitId = _unitId, name = string.format("Descarregar / montar %s #%i", _types[1], _unitId) }
        ...
        for _i, _pos in ipairs(_positions) do
            ...
            local _unitId = ctld.getNextUnitId()
            local _details = { type = _types[_i], unitId = _unitId, name = string.format("Descarregar / montar %s #%i", _types[_i], _unitId) }
...
function ctld.dropSmoke(_args)
    ...
    if _heli ~= nil then
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " marcando local com fumaça " .. _colour .. ".", 10)
    end
end
            ...
            if _unit ~= nil then
                ...
                if _groupId then
                    ...
                    if ctld.addedTo[tostring(_groupId)] == nil then
                        ...
                        local _rootPath = missionCommands.addSubMenuForGroup(_groupId, "Logística (CTLD)") --Nome que aparece no menu principal

                        local _unitActions = ctld.getUnitActions(_unit:getTypeName())
                        ctld.logTrace(string.format("_unitActions=%s", ctld.p(_unitActions)))

                        missionCommands.addCommandForGroup(_groupId, "Checar Informação de Carga", _rootPath, ctld.checkTroopStatus, { _unitName })

                        if _unitActions.troops then

                            local _troopCommandsPath = missionCommands.addSubMenuForGroup(_groupId, "Transporte de Tropas", _rootPath)

                            missionCommands.addCommandForGroup(_groupId, "Desembarcar / Extrair Tropas", _troopCommandsPath, ctld.unloadExtractTroops, { _unitName })
                            ...
                            for _,_loadGroup in pairs(ctld.loadableGroups) do
                                ...
                                if not _loadGroup.side or _loadGroup.side == _unit:getCoalition() then
                                    ...
                                    if _transportLimit >= _loadGroup.total then
                                        missionCommands.addCommandForGroup(_groupId, "Carregar ".._loadGroup.name, _troopCommandsPath, ctld.loadTroopsFromZone, { _unitName, true,_loadGroup,false }) -- Aparece no menu de opções antes de cada opção de transporte de tropas
                                    end
                                end
                            end
                            ...
                            if ctld.unitCanCarryVehicles(_unit) then
                                ...
                                missionCommands.addCommandForGroup(_groupId, "Descarregar Veículos", _vehicleCommandsPath, ctld.unloadTroops, { _unitName, false })
                                missionCommands.addCommandForGroup(_groupId, "Carregar / Desembarcar Veículos", _vehicleCommandsPath, ctld.loadTroopsFromZone, { _unitName, false,"",true })

                                if ctld.enabledFOBBuilding and ctld.staticBugWorkaround == false then

                                    missionCommands.addCommandForGroup(_groupId, "Carregar / Descarregar Container de FOB", _vehicleCommandsPath, ctld.loadUnloadFOBCrate, { _unitName, false })
                                end
                                missionCommands.addCommandForGroup(_groupId, "Checar Informação de Carga", _vehicleCommandsPath, ctld.checkTroopStatus, { _unitName })
                            end
                        ...
                        if (ctld.enabledFOBBuilding or ctld.enableCrates) and _unitActions.crates then
                            ...
                            local _crateCommands = missionCommands.addSubMenuForGroup(_groupId, "Comandos de Cargas CTLD", _rootPath)
                            if ctld.hoverPickup == false then
                                if  ctld.slingLoad == false then
                                    missionCommands.addCommandForGroup(_groupId, "Embarcar Carga Próxima", _crateCommands, ctld.loadNearbyCrate,  _unitName )
                                end
                            end

                            missionCommands.addCommandForGroup(_groupId, "Abrir Carga e Construir", _crateCommands, ctld.unpackCrates, { _unitName })

                            if ctld.slingLoad == false then
                                missionCommands.addCommandForGroup(_groupId, "Descarregar Carga", _crateCommands, ctld.dropSlingCrate, { _unitName })
                            end

                            missionCommands.addCommandForGroup(_groupId, "Listar Cargas Próximas", _crateCommands, ctld.listNearbyCrates, { _unitName })

                            if ctld.enabledFOBBuilding then
                                missionCommands.addCommandForGroup(_groupId, "Listar FOBs", _crateCommands, ctld.listFOBS, { _unitName })
                            end
                        end


                        if ctld.enableSmokeDrop then
                            local _smokeMenu = missionCommands.addSubMenuForGroup(_groupId, "Marcar Local Com Fumaça", _rootPath)
                            missionCommands.addCommandForGroup(_groupId, "Marcar com fumaça Vermelha", _smokeMenu, ctld.dropSmoke, { _unitName, trigger.smokeColor.Red })
                            missionCommands.addCommandForGroup(_groupId, "Marcar com fumaça Azul", _smokeMenu, ctld.dropSmoke, { _unitName, trigger.smokeColor.Blue })
                            missionCommands.addCommandForGroup(_groupId, "Marcar com fumaça Laranja", _smokeMenu, ctld.dropSmoke, { _unitName, trigger.smokeColor.Orange })
                            missionCommands.addCommandForGroup(_groupId, "Marcar com fumaça Verde", _smokeMenu, ctld.dropSmoke, { _unitName, trigger.smokeColor.Green })
                        end
                        ...
                        if ctld.enabledRadioBeaconDrop then
                            ...
                            missionCommands.addCommandForGroup(_groupId, "Listar Beacons", _radioCommands, ctld.listRadioBeacons, { _unitName })
                            missionCommands.addCommandForGroup(_groupId, "Drop Beacon", _radioCommands, ctld.dropRadioBeacon, { _unitName })
                            missionCommands.addCommandForGroup(_groupId, "Remover Beacon Próximo", _radioCommands, ctld.removeRadioBeacon, { _unitName })
...
function ctld.JTACAutoLase(_jtacGroupName, _laserCode, _smoke, _lock, _colour, _radio)
    ...
    if _enemyUnit == nil then
        ...
        if _enemyUnit ~= nil then
            ...
            local action = " Iluminando novo alvo, "
				trigger.action.outSound('JTAC - OnToVisual.ogg') --toca áudio ao iluminar alvo com jtac
            if targetLost then
                action = ", alvo perdido." .. action
                targetLost = false
            elseif targetDestroyed then
                action = ", alvo destruído " .. action
				trigger.action.outSound('JTAC - Good Hit Good Hit.ogg') --toca áudio ao destruir alvo sendo iluminado pelo jtac
                targetDestroyed = false
            end

            local message = _jtacGroupName .. action .. _enemyUnit:getTypeName()
            local fullMessage = message .. '. Código: ' .. _laserCode .. ". Coordenadas: " .. ctld.getPositionString(_enemyUnit) -- Onde está escrito LOCALIZAÇÃO: estava antes escrito Coordenadas e onde está Código, estava antes CODE
    ...
    if targetLost then
        ctld.notifyCoalition(_jtacGroupName .. ", alvo perdido.", 10, _jtacUnit:getCoalition(), _radio)
    elseif targetDestroyed then
        ctld.notifyCoalition(_jtacGroupName .. ", alvo destruído.", 10, _jtacUnit:getCoalition(), _radio)
    end
end
    ...
    for _jtacGroupName, _jtacDetails in pairs(ctld.jtacUnits) do
        ...
        if _jtacUnit ~= nil and _jtacUnit:getLife() > 0 and _jtacUnit:isActive() == true and _jtacUnit:getCoalition() == _side then
            ...
            if (_jtacDetails.radio) then
                _start = _start .. ", JTAC disponível na frequência ".._jtacDetails.radio.freq.." ".._jtacDetails.radio.mod ..","
            end

            if _laserCode == nil then
                _laserCode = "Não Identificado"
            end

            if _enemyUnit ~= nil and _enemyUnit:getLife() > 0 and _enemyUnit:isActive() == true then
                _message = _message .. "" .. _start .. " iluminando " .. _enemyUnit:getTypeName() .. " Código: " .. _laserCode .. ctld.getPositionString(_enemyUnit) .. "\n"

                local _list = ctld.listNearbyEnemies(_jtacUnit)

                if _list then
                    _message = _message.."tem o visual em: "
                ...
                _message = _message .. "" .. _start .. " procurando alvos" .. ctld.getPositionString(_jtacUnit) .. "\n"
            end
        end
    end

    if _message == "JTAC STATUS: \n\n" then
        _message = "Não há nenhum JTAC ativo!"
    end
