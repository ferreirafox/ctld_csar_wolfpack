...
ctld.spawnableCrates = {
    ...
    ["SAMs de longo alcance"] = {
        ...
        { weight = 585, desc = "SA-10 S-300 Grumble Big Bird Repair", unit = "S-300 Repair" , side = 1 },
        -- End of S-300

        { weight = 586, desc = "Early Warning Radar", unit = "1L13 EWR", side = 1 }, -- cant be used by BLUE coalition
    },
}
